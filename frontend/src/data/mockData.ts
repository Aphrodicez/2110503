...
export const mockCampgrounds: Campground[] = [
  {
    ...
    description:
      "Nestled in a beautiful pine forest with hiking trails and river access.",
  },
  {
    id: "2",
    ...
    description:
      "Peaceful lakeside camping with swimming and fishing opportunities.",
  },
  {
    id: "3",
    ...
    description:
      "High-altitude camping with stunning mountain views and stargazing.",
  },
  {
    id: "4",
    ...
    description:
      "Tranquil riverside location perfect for kayaking and nature walks.",
  },
  {
    id: "5",
    ...
    description:
      "Unique desert experience with stunning rock formations and sunsets.",
  },
  {
    id: "6",
    ...
    description:
      "Beachside camping with ocean views and coastal hiking trails.",
  },
];
...
export const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Amazing experience! The pine forest was breathtaking and the facilities were top-notch.",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Great location and well-maintained trails. Would definitely come back!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Perfect lakeside retreat. Fishing was excellent and the sunset views were spectacular.",
